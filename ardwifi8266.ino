...
void loop() {
  ...
  String veri = "GET https://api.thingspeak.com/update?api_key=E9RQJI5791QO74YJ&field1=0";   //Thingspeak komutu. Key kısmına kendi api keyimizi yazıyoruz.
  veri += String(sensorValue);                                        //Göndereceğimiz nem değişkeni
  veri += "&field2=";
  veri += String(sensorValue2);
  veri += "\r\n\r\n";
